...
// microsd card
cutout(-pcbw/2+56-0.2,-pcbw/2+72+0.2,-pcbh/2-2,0,-3,1.2);

// power switch
cutout(pcbw/2-5,pcbw/2+5,pcbh/2-14,pcbh/2-8,-3,1.2);
...
cutoutc(-pcbw/2+7,-pcbw/2+23,-pcbh/2+3,-pcbh/2+11,0,12.1);
}
