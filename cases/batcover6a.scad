...
difference(){
union(){
cutoutc(-29.6-1.0,28.6+1.0,-17.4-0.6,15+0.6,-(thk-ith)/2,-(thk-ith)/2+1.0);
cutoutc(-29.6+0.2,28.6-0.2,-17.4+0.6,15-0.6,-(thk-ith)/2+1.0,-(thk-ith)/2+1.4);

cutoutc(-2+0.2,2-0.2,-20.2+1.6,17.8-1.6,-(thk-ith)/2+0.8,-(thk-ith)/2+1.4);
cutoutc(-22+0.2,-18-0.2,-20.2+1.6,17.8-1.6,-(thk-ith)/2+0.8,-(thk-ith)/2+1.4);
cutoutc(18+0.2,22-0.2,-20.2+1.6,17.8-1.6,-(thk-ith)/2+0.8,-(thk-ith)/2+1.4);
}

cutout(-7,7,7,12,-15,-(thk-ith)/2+0.6);

cutoutc(27,32,-3,3,-(thk-ith)/2+0.6,0);
cutoutc(-32,-27,-3,3,-(thk-ith)/2+0.6,0);
}
