...
// power switch
cutoutc(pcbw/2-5,pcbw/2+wts,pcbh/2-16,pcbh/2-8,(thk-ith)/2,(thk-ith)/2+ith);
}

cutoutc(-29,30,-12.4,20,-15,15);
cutoutc(-29-1,30+1,-12.4-1,20+1,-15,-(thk-ith)/2+1);

//cutoutc(-45,-35,-30,30,thk/2-0.8,thk/2+0.1);
//cutoutc(35,45,-30,30,thk/2-0.8,thk/2+0.1);

cutoutc(-2,2,-15.2,22.8,-(thk-ith)/2+0.6,-(thk-ith)/2+1.6);
cutoutc(-22,-18,-15.2,22.8,-(thk-ith)/2+0.6,-(thk-ith)/2+1.6);
cutoutc(18,22,-15.2,22.8,-(thk-ith)/2+0.6,-(thk-ith)/2+1.6);
...
translate([pcbw/2-4,pcbh/2-4,thk/2-26-1.8])
hole2();
translate([pcbw/2-4,-pcbh/2+4,thk/2-26-1.8])
hole2();
translate([-pcbw/2+4,pcbh/2-4,thk/2-26-1.8])
