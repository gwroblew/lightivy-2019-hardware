...
difference(){
union(){
roundedCube([pcbw+fit*2-0.2,pcbh+fit*2-0.2,2.8],center=true,r=5,x=false,y=false,rx=[2,2,2,2],ry=[2,2,2,2]);
}

cutoutc(-29.6,28.6,-17.4,15,-5,5);

cutoutc(-45,-35,-30,30,0.6,1.6);
cutoutc(35,45,-30,30,0.6,1.6);

translate([pcbw/2-4,pcbh/2-4,-3])
hole();
translate([pcbw/2-4,-pcbh/2+4,-3])
hole();
translate([-pcbw/2+4,pcbh/2-4,-3])
