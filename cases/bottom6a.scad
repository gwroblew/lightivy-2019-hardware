...
difference(){
union(){
roundedCube([pcbw+wts*2,pcbh+wts*2,thk-ith],center=true,r=5+wts,x=true,y=true,rx=[7,0,0,7],ry=[0,0,thk-ith,thk-ith]);

translate([0,0,(thk-ith)/2+ith/2])
roundedCube([pcbw+fit*2-0.2,pcbh+fit*2-0.2,ith],center=true,r=5,x=false,y=false);

// power switch
cutoutc(pcbw/2-5,pcbw/2+wts,pcbh/2-14,pcbh/2-8,(thk-ith)/2,(thk-ith)/2+ith);
}

cutoutc(-29.6,28.6,-17.4,15,-15,15);
cutoutc(-29.6-1,28.6+1,-17.4-1,15+1,-15,-(thk-ith)/2+1);

//cutoutc(-45,-35,-30,30,thk/2-0.8,thk/2+0.1);
//cutoutc(35,45,-30,30,thk/2-0.8,thk/2+0.1);

cutoutc(-2,2,-20.2,17.8,-(thk-ith)/2+0.6,-(thk-ith)/2+1.6);
cutoutc(-22,-18,-20.2,17.8,-(thk-ith)/2+0.6,-(thk-ith)/2+1.6);
cutoutc(18,22,-20.2,17.8,-(thk-ith)/2+0.6,-(thk-ith)/2+1.6);

translate([pcbw/2-4,pcbh/2-4,-9])
hole();
translate([pcbw/2-4,-pcbh/2+4,-9])
hole();
translate([-pcbw/2+4,pcbh/2-4,-9])
...
translate([pcbw/2-4,pcbh/2-4,thk/2-26-2.8])
hole2();
translate([pcbw/2-4,-pcbh/2+4,thk/2-26-2.8])
hole2();
translate([-pcbw/2+4,pcbh/2-4,thk/2-26-2.8])
