...
difference(){
union(){
roundedCube([pcbw+wts*2,pcbh+wts*2,thk-ith],center=true,r=5+wts,x=true,y=true,rx=[4,0,0,4],ry=[0,0,4,4]);
...
// usb port
cutoutc(pcbw/2-16.2,pcbw/2-7.8,-pcbh/2-wts,-pcbh/2-fit,(thk-ith)/2,(thk-ith)/2+ith+1.4);
}

cutoutc(-btw/2,btw/2,-btl/2,btl/2,(thk-ith)/2+ith-bth,15);
// battery wires cutout
cutoutc(btw/2-25,btw/2,-btl/2,btl/2,(thk-ith)/2+ith-bth-0.8,15);
cutoutc(pcbw/2-35,pcbw/2-7,pcbh/2-10,pcbh/2-1,(thk-ith)/2-ith/2-1.2,(thk-ith)/2+ith+1.0);
...
translate([pcbw/2-4,pcbh/2-4,thk/2-26-2.0])
hole2();
translate([pcbw/2-4,-pcbh/2+4,thk/2-26-2.0])
hole2();
translate([-pcbw/2+4,pcbh/2-4,thk/2-26-2.0])
